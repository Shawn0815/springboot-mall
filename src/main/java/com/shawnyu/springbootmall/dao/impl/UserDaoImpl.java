...
import com.shawnyu.springbootmall.rowmapper.UserRowMapper;
...
public class UserDaoImpl implements UserDao {
    ...
    public Integer createUser(UserRegisterRequest userRegisterRequest) {
        String sql = "INSERT INTO user(user_name, email, password, created_date, last_modified_date) " +
                "VALUES (:userName, :email, :password, :createdDate, :lastModfiedDate)";

        Map<String, Object> map = new HashMap<>();

        map.put("userName", userRegisterRequest.getName());
